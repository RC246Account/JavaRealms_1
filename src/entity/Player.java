...
public class Player extends Entity {
	...
	public int getKnowledge() {
	    int bonus = 0;
	    if (currentWeapon != null) bonus += currentWeapon.knowledgeValue;
	    if (currentShield != null) bonus += currentShield.knowledgeValue;
	    return baseKnowledge + bonus;
	}
	...
	public void contactMonster(int i) {
		...
		if(i != 999) {
	        ...
	        if (!invincible && !monster.dying) {	
				// CHANGE SOUND TO TRANSITION TO BATTLE SOUND
				gp.playSE(6);
				
				String chapter = "";
	            String difficulty = "";
				
	            // Use monster.type to determine which quiz to load
	            switch (monster.typeChapter) {
	                case 1: chapter = "chap1"; break;
	                case 2: chapter = "chap2"; break;
	                case 3: chapter = "chap3"; break;
	                case 4: chapter = "chap4"; break;
	                default: chapter = "chap1"; break;
	            }
	            
	            switch (monster.typeDifficulty) {
	                case 0: difficulty = "easy"; break; // 0 = fodder
	                case 1: difficulty = "hard"; break; // 1 = boss
	                default: difficulty = "easy"; break;
	            }
	         
	            // Load quiz questions
	            gp.ui.currentQuiz = QuestionLoader.loadQuestions(chapter, difficulty);
	            gp.ui.quizIndex = 0;
...
//		}
	...
	public void checkLevelUp() {
		...
		if(exp >= nextLevelExp) {
	        ...
	        life = maxLife; // Set life to maxLife when leveling up
