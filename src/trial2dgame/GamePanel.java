...
//NEW CODE!!
    ...
    public void resetGame(boolean restart) {
        ...
        if (restart) {
         ...
         // Make sure lighting exists
            if (eManager.lighting == null) {
                eManager.setup(); // initialize lighting if not done
            }
    ...
    public void update() {
        ...
        if (gameState == battleState) {
            if (keyH.enterPressed) {
                int selectedChoice = ui.commandNum;
                ui.handleQuizAnswer(selectedChoice);
    ...
    /**
     * Draws the world as in playState (tiles, interactive tiles, entities, objects, monsters, environment)
     * but without UI overlays or minimap.
     */
